...
uses
  ...
  dxSkinBasic, dxDateRanges, dxScrollbarAnnotations, FireDAC.Phys.MSSQLDef,
  FireDAC.VCLUI.Wait, dxUIAClasses;
...
type
  TfrmTranslations = class(TForm)
    ...
    FDConnectionSrc: TFDConnection;
    FDConDest: TFDConnection;
...
//    property DBConnection: TFDConnection read fDBConnection write fDBConnection;
  ...
  public
    { Public declarations }
    constructor createWithDBConnection(pmSender: TComponent; pmConnector: TFDConnection);
  end;
...
constructor TfrmTranslations.createWithDBConnection(pmSender: TComponent; pmConnector: TFDConnection);
var
  s: string;
begin
  inherited create(pmSender);
  FDConnectionSrc := pmConnector;
end;
