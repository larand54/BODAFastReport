...
uses
  ...
  Vcl.Grids, Vcl.DBGrids, FireDAC.Comp.UI, FireDAC.Phys.MSSQLDef;
...
{$R *.dfm}
const
  cAlvesql01 = 'AML-NET-RDS-011\WOODSUPPORT';
  cAlvesql03 = 'AML-NET-RDS-011\WOODSUPPORT';
  cAlvesqlTest = 'AML-NET-RDS-011\WOODSUPPORT';
...
procedure TfrmCopyTables.setUpConnection(aConnection: TFDConnection;
  aServer: string);
begin
// Do nothing until we need this function
end;
